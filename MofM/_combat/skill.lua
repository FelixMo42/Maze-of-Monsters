...
abilities["skip turn"] = abilitie:new({name="skip turn"})
abilities["defend"] = abilitie:new({name="defend"})
abilities["defend"].func = function(p,t)
	local p = p or player[math.floor(turn/2)*2-turn+2]
	local t = t or player[math.floor(turn/2)*2-turn+2]
	t.bonuses["def"] = {t = 1, b = 10}
end
abilities["dodge"] = abilitie:new({name="dodge"})
...
abilities["heal"] = abilitie:new({name="heal",mana=10})
